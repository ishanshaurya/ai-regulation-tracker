    ...
    <div className="animate-fade-in">
      ...
      <div style={{ marginBottom: 24, display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 11, color: "#475569" }}>Paste your project files → Get a scored report card across 5 categories <span style={{ color: "#f59e0b", marginLeft: 8 }}>● Demo Mode</span></p>
        </div>
      </div>
